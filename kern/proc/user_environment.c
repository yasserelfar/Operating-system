...
//	{
//			uint32 size =e->page_WS_list.size/PAGE_SIZE;
//			struct WorkingSetElement* fifoele=NULL;
//			LIST_FOREACH(fifoele,&e->page_WS_list)
//			{
//				env_page_ws_invalidate( e, fifoele->virtual_address);
//				unmap_frame(e->env_page_directory,fifoele->virtual_address);
//				kfree((void *)fifoele->virtual_address);
//				pt_clear_page_table_entry(e->env_page_directory, fifoele->virtual_address) ;
//				pd_clear_page_dir_entry(e->env_page_directory, fifoele->virtual_address) ;
//			}
//				 return;
//	}
//	if(isPageReplacmentAlgorithmLRU(PG_REP_LRU_LISTS_APPROX))
//	{
//		struct WorkingSetElement* lruele1=NULL;
//		struct WorkingSetElement* lruele2=NULL;
//		LIST_FOREACH(lruele1,&e->ActiveList)
//		{
//			env_page_ws_invalidate( e, lruele1->virtual_address);
//			kfree((void *)lruele1->virtual_address);
//			pt_clear_page_table_entry(e->env_page_directory,lruele1->virtual_address ) ;
//			pd_clear_page_dir_entry(e->env_page_directory, lruele1->virtual_address) ;
//		}
//		LIST_FOREACH(lruele2,&e->SecondList)
//		{
//			env_page_ws_invalidate( e, lruele2->virtual_address);
//			kfree((void *)lruele2->virtual_address);
//			pt_clear_page_table_entry(e->env_page_directory, lruele2->virtual_address) ;
//			pd_clear_page_dir_entry(e->env_page_directory, lruele2->virtual_address) ;
//		}
//		return;
//	}
...
//===============================================
	void initialize_uheap_dynamic_allocator(struct Env* e, uint32 daStart, uint32 daLimit)
	{
		...
		//cprintf("in initializeee\n");
		e->start_U_heap=daStart;
		e->hard_U_limit=daLimit;
		e->segment_U_break=daStart;
		initialize_dynamic_allocator(daStart,0);
		//cprintf("in initializeee end\n");
