...
//	cprintf("start creat\n");
//	cprintf("address=:%p\n",virtual_address);
	void *temp = kmalloc((sizeof(struct WorkingSetElement)));

//	cprintf("temp set elements:%u\n",temp);
	struct WorkingSetElement* workingSetElementPointer = (struct WorkingSetElement*)temp ;
//	cprintf("working set elements:%u\n",workingSetElementPointer);
	//	env_page_ws_print(e);
	if (workingSetElementPointer == NULL)
			panic("failure");

	workingSetElementPointer->virtual_address = virtual_address;

//	cprintf("end creat\n");

	return workingSetElementPointer;
